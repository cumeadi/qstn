...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createStore = (0, _redux.createStore)(_reducer2.default);

	var dispatch = _createStore.dispatch;
	var getState = _createStore.getState;

	/**
	 * Render fn
	 */

	var render = (0, _deku.createApp)(document.body, dispatch);

	/**
	 * Render <App/>
	 */

	render((0, _deku.element)(_App2.default, null), getState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (state, _ref) {
	  ...
	  var next = (0, _extends3.default)({}, state);
